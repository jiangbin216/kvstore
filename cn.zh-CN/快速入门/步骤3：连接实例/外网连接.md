...
4.  在实例信息页，单击**连接信息**区域的**申请外网连接**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/141285/156448117641043_zh-CN.png)

5.  在申请外网连接对话框输入自定义的连接地址和端口，或保留默认值，之后单击**确定**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/855894/156448117751044_zh-CN.png)
...
## 连接失败的解决方法 {#section_y2n_4gp_hb5 .section}
