...
3.  在实例信息页的左侧导航栏中，单击**参数设置**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3137/154717178313235_zh-CN.png)

4.  单击目标参数操作列的**修改**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3137/154717178313236_zh-CN.png)
